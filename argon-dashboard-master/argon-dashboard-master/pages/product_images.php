...
if (isset($_POST['submit'])) {
    ...
    foreach ($images['tmp_name'] as $index => $tmp_name) {
        ...
        if (move_uploaded_file($tmp_name, $filepath)) {
            ...
            $sql = "INSERT INTO product_images (product_id, img_path) VALUES (?, ?)";
            $stmt = $conn->prepare($sql);
            $stmt->bind_param('is', $product_id, $filepath);
            $stmt->execute();
        }
    }
}
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Product_images</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Product_images</h6>
        </nav>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body px-0 pt-0 pb-2">
            ...
            <form action="pimages.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="images" class="form-label">Product Images (Choose multiple files):</label>
                    <input type="file" name="images[]" class="form-control" multiple required>
                </div>
                <div class="d-flex justify-content-start">
                    <button type="submit" name="submit" class="btn btn-primary btn-sm">Upload Images</button>
                </div>
            </form>
        </div>
    </div>
                            ...
                            <tbody>
                                <?php foreach ($img_path as $key => $image) : ?>
                                    <tr>
                                        ...
                                        <td>
                                        <a href="update_image.php?id=<?php echo $image['id']; ?>&product_id=<?php echo $image['product_id']; ?>" class="btn btn-success btn-sm">Update</a>
