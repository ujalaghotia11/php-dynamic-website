        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()) { ?>
                <tr>
                    ...
                    <td>
                        <!-- Wrap the Pending button with an anchor tag to redirect to approve_deposit.php -->
                        <?php if ($row['status'] == 'pending') { ?>
                            <a href="withdrawal_status.php?approve_id=<?php echo $row['id']; ?>" class="btn btn-warning">Pending</a>
                        <?php } ?>
                    </td>
                </tr>
            <?php } ?>
