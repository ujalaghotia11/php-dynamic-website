  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
            <a class="nav-link active" href="../pages/forms.html">
              <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                <i class="ni ni-calendar-grid-58 text-dark text-sm opacity-10"></i>
              </div>
  ...
  <main class="main-content position-relative border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-white active" aria-current="page">Forms</li>
          </ol>
          <h6 class="font-weight-bolder text-white mb-0">Forms</h6>
        </nav>
    ...
    <div class="form-container">
        ...
        <?php if (!empty($row['img'])): ?>
            <h3>Uploaded Logo:</h3>
            <img src="<?php echo $row['img']; ?>" alt="Logo">
        <?php endif; ?>
    </div>
    <div class="form-container">
        <h2>Upload Banner</h2>
...
<div class="container py-5">
        ...
        <form method="POST" action="pmdb.php" enctype="multipart/form-data">
    ...
    <div class="category-list">
        <?php while ($category = mysqli_fetch_assoc($result_categories)): ?>
            <div class="category-item">
                <img src="images/<?php echo $category['image']; ?>" alt="<?php echo $category['name']; ?>" width="100px">
                <h3><?php echo $category['name']; ?></h3>
                <a href="add_product.php?category_id=<?php echo $category['id']; ?>" class="button">Add Product</a>
